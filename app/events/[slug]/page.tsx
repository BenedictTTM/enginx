...
export default function EventDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data: event, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (!res.success) throw new Error(res.message || "Failed to load event details.");
      return res.data;
    }
  });
  ...
  if (error || !event) {
    const errorMessage = error instanceof Error ? error.message : "Event not found.";
    return (
              ...
              <div className="border-t border-gray-800 pt-4 space-y-4 text-sm text-gray-300">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      {getDisplayRegisteredCount(event.createdAt, event.registeredCount)}
